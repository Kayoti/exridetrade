      ...
      <div class=" w-full flex justify-center items-center ">
        ...
        <div class="flex flex-col gap-4 max-w-100 rounded-xl shadow-xl p-10">
            ...
            <div class="relative inline-flex w-full my-1 " >
                                    ...
                                    <input disabled  type="text" class="rounded-e-2xl py-3 px-5 border border-s-0 border-black/20 flex-grow" v-model="store.$state.form.vehicle_info.make" >
                                </div> 
                                ...
                                <div class="relative inline-flex w-full my-1 " >
                                    ...
                                    <input disabled  type="text" class="rounded-e-2xl py-3 px-5 border border-s-0 border-black/20 flex-grow" v-model="store.$state.form.vehicle_info.model" >
                                </div> 
...
//     otherImages.value.push(carbackangle, carseats, cardash);
...
//     formData1.append('cf_1782', 'draft');
